...
<article class="prose mx-auto text-base prose-headings:font-[500]">
    <Figure css="transition-opacity group-hover:opacity-50 pb-6" alt={post.title} img={post.coverImage} sm md lg xl xxl width={post.coverImage.width} height={post.coverImage.height} i/>
